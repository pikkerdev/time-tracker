...
object TestData {
  ...
  val projectStats2 = mapOf(LocalDate.of(2026, 6, 1) to MonthlyStats(20.d, 40.d, 60.d, 80.d))
  val projectView = ProjectView(project, projectStats2)
  ...
  val invoiceRow = InvoiceRow(description = "Invoice row", hours = 3.d, rate = 5.d, amount = 15.d )
  val invoice = Invoice(InvoiceId(2026060101), project.id, LocalDate.of(2026, 6, 1),"Invoice 1", description = "development", dueDate = LocalDate.of(2026, 6, 14), revenueMonth = LocalDate.of(2026, 5, 1), rows = listOf(invoiceRow))
  ...
  val invoiceCreateRequest = InvoiceCreateRequest(LocalDate.of(2026, 6, 1), listOf(timeEntry.id, timeEntry2.id),"Invoice 1", description= "development", dueDate = LocalDate.of(2026, 6, 14), revenueMonth = LocalDate.of(2026, 5, 1), rows = listOf(invoiceRow))
